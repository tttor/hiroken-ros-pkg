...
public:
  ...
  public:
    static inline FltArray15_slice* alloc() { return ::coordServer::FltArray15_alloc(); }
    static inline FltArray15_slice* dup(const FltArray15_slice* p) { return ::coordServer::FltArray15_dup(p); }
    static inline void free(FltArray15_slice* p) { ::coordServer::FltArray15_free(p); }
  };
  ...
  public:
    static inline BolArray15_slice* alloc() { return ::coordServer::BolArray15_alloc(); }
    static inline BolArray15_slice* dup(const BolArray15_slice* p) { return ::coordServer::BolArray15_dup(p); }
    static inline void free(BolArray15_slice* p) { ::coordServer::BolArray15_free(p); }
  };
  ...
  public:
    static inline LngArray15_slice* alloc() { return ::coordServer::LngArray15_alloc(); }
    static inline LngArray15_slice* dup(const LngArray15_slice* p) { return ::coordServer::LngArray15_dup(p); }
    static inline void free(LngArray15_slice* p) { ::coordServer::LngArray15_free(p); }
  };
  ...
  public:
    static inline LngArray4_slice* alloc() { return ::coordServer::LngArray4_alloc(); }
    static inline LngArray4_slice* dup(const LngArray4_slice* p) { return ::coordServer::LngArray4_dup(p); }
    static inline void free(LngArray4_slice* p) { ::coordServer::LngArray4_free(p); }
  };
  ...
  public:
    static inline DoubleArray6_slice* alloc() { return ::coordServer::DoubleArray6_alloc(); }
    static inline DoubleArray6_slice* dup(const DoubleArray6_slice* p) { return ::coordServer::DoubleArray6_dup(p); }
    static inline void free(DoubleArray6_slice* p) { ::coordServer::DoubleArray6_free(p); }
  };
