...
class Robot(_object):
    ...
    def setDout(self, *args): return _KSP.Robot_setDout(self, *args)
    def getDout(self, *args): return _KSP.Robot_getDout(self, *args)
    def getDoutAll(self): return _KSP.Robot_getDoutAll(self)
