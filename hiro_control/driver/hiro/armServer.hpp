...
public:
  ...
  public:
    static inline FltArray15_slice* alloc() { return ::armServer::FltArray15_alloc(); }
    static inline FltArray15_slice* dup(const FltArray15_slice* p) { return ::armServer::FltArray15_dup(p); }
    static inline void free(FltArray15_slice* p) { ::armServer::FltArray15_free(p); }
  };
  ...
  public:
    static inline BolArray15_slice* alloc() { return ::armServer::BolArray15_alloc(); }
    static inline BolArray15_slice* dup(const BolArray15_slice* p) { return ::armServer::BolArray15_dup(p); }
    static inline void free(BolArray15_slice* p) { ::armServer::BolArray15_free(p); }
  };
  ...
  public:
    static inline LngArray15_slice* alloc() { return ::armServer::LngArray15_alloc(); }
    static inline LngArray15_slice* dup(const LngArray15_slice* p) { return ::armServer::LngArray15_dup(p); }
    static inline void free(LngArray15_slice* p) { ::armServer::LngArray15_free(p); }
  };
  ...
  public:
    static inline LngArray4_slice* alloc() { return ::armServer::LngArray4_alloc(); }
    static inline LngArray4_slice* dup(const LngArray4_slice* p) { return ::armServer::LngArray4_dup(p); }
    static inline void free(LngArray4_slice* p) { ::armServer::LngArray4_free(p); }
  };
