...
unsigned long long Robot::getDin()
{
  return this->dio->getDin(); 
}

unsigned long Robot::getDout(unsigned short port)
{
  return this->dio->getDout(port); 
}

unsigned long long Robot::getDoutAll()
{
  return this->dio->getDoutAll(); 
}

bool Robot::setDout(unsigned short port, unsigned long blinkingCycle)
{
  return this->dio->setDout(port, blinkingCycle); 
}
