...
_CORBA_MODULE_BEG
  ...
  public:
    static inline LngArray4_slice* alloc() { return ::protectPluginTypes::LngArray4_alloc(); }
    static inline LngArray4_slice* dup(const LngArray4_slice* p) { return ::protectPluginTypes::LngArray4_dup(p); }
    static inline void free(LngArray4_slice* p) { ::protectPluginTypes::LngArray4_free(p); }
  };
